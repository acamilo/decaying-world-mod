...
public class ProtectionBlockMenu extends AbstractContainerMenu {
    ...
    public ProtectionBlockMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId,inv,inv.player.level.getBlockEntity(extraData.readBlockPos()),
                new SimpleContainerData(2));

    }
    public ProtectionBlockMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.PROTECTION_BLOCK_MENU.get(), pContainerId);
        checkContainerSize(inv,1);
        blockEntity = ((ProtectionBlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.PROTECTION_BLOCK.get());
    }
